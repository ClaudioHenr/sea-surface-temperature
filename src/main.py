...
def processar_imagem(image_path, ano):
    ...
    # 4. Aplicar o threshould de OTSU
...
for ano in anos:
    caminho = f"C:/Users/AlphaPlayerOne/Desktop/FaculThales/PDI/TRABFINAL/sea-surface-temperature/assets/ocean/BMP/ocean_temp_sep_{ano}.bmp"  # Ajustar os caminhos das imagens
